...
public class GameClient
{
  ...
  public static final String ANSI_RED ="A";
  public static final String ANSI_GREEN = "B";
  public static final String ANSI_YELLOW = "C";
  public static final String ANSI_BLUE = "D";
  public static final String ANSI_PURPLE = "E";
  public static final String ANSI_CYAN = "F";
  public static final String ANSI_WHITE = "G";
          ...
          for(int i = 0; i < length; i++)
          {
            for(int j = 0; j < width; j++)
            {
              switch(response.charAt(count++) - '0')
              {
                ...
                case 4:System.out.print(ANSI_PURPLE); break;
              }
